            ...
            <div class="flex items-center justify-center min-h-screen text-center" :class="ocrMaximized ? 'h-screen w-screen p-0 items-stretch' : 'pt-4 px-4 pb-20 align-middle'">
                ...
                <div :class="ocrMaximized ? 'w-screen h-screen max-w-full my-0 rounded-none flex flex-col' : 'inline-block align-middle sm:max-w-4xl sm:w-full rounded-2xl sm:my-8 border border-slate-150'"
                    ...
                    <div class="bg-slate-55 border-b border-slate-150 px-6 py-4 flex items-center justify-between shrink-0 bg-slate-50">
                        <div class="flex gap-2">
                            <button type="button" wire:click="$set('activeImportTab', 'excel')" 
                                    class="py-2 px-1 text-[13px] border-b-2 transition duration-150 <?php echo e($activeImportTab === 'excel' ? 'border-indigo-650 text-indigo-650 font-black' : 'border-transparent text-slate-500 font-bold hover:text-slate-700'); ?>">
                                📥 Nhập từ Excel/CSV linh hoạt
                            </button>
                            <button type="button" wire:click="$set('activeImportTab', 'pdf')" 
                                    class="py-2 px-1 text-[13px] border-b-2 transition duration-150 flex items-center gap-1 <?php echo e($activeImportTab === 'pdf' ? 'border-indigo-650 text-indigo-650 font-black' : 'border-transparent text-slate-500 font-bold hover:text-slate-700'); ?>">
                                📋 Nhập từ tệp tin PDF
                            ...
                            <button type="button" wire:click="$set('activeImportTab', 'ocr')" 
                                    class="py-2 px-1 text-[13px] border-b-2 transition duration-150 flex items-center gap-1.5 <?php echo e($activeImportTab === 'ocr' ? 'border-indigo-650 text-indigo-650 font-black' : 'border-transparent text-slate-500 font-bold hover:text-slate-700'); ?>">
                    ...
                    <div :class="ocrMaximized ? 'flex-1 overflow-y-auto' : ''">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeImportTab === 'excel'): ?>
