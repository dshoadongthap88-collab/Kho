            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="hover:bg-slate-50">
                        <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-gray-900"><?php echo e($asset['asset_code']); ?></td>
                        <td class="px-2 py-1.5 whitespace-nowrap text-sm font-medium text-gray-600"><?php echo e($asset['name']); ?></td>
                        <td class="px-2 py-1.5 whitespace-nowrap text-sm text-gray-900"><?php echo e(number_format($asset['current_odo'], 1)); ?></td>
                        <td class="px-2 py-1.5 whitespace-nowrap text-sm text-gray-500"><?php echo e($asset['maintenance_cycle']); ?></td>
                        <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold <?php echo e($asset['is_overdue'] ? 'text-red-600' : ($asset['is_warning'] ? 'text-yellow-600' : 'text-green-600')); ?>">
