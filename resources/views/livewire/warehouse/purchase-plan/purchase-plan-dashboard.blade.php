<div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border border-slate-200">
            ...
            <p class="text-3xl font-black text-slate-800">{{ $totalPlans }}</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border border-slate-200">
            ...
            <p class="text-3xl font-black text-emerald-600">{{ $completedPlans }}</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border border-slate-200">
            ...
            <p class="text-3xl font-black text-amber-600">{{ $partialPlans }}</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border border-slate-200">
            ...
            <p class="text-3xl font-black text-rose-600">{{ $unreceivedPlans }}</p>
        </div>
        ...
        <div class="bg-slate-800 rounded-xl shadow-sm p-5 border border-slate-700">
            ...
            <p class="text-3xl font-black text-white">{{ number_format($totalMissing, 0) }}</p>
        </div>
    </div>
</div>
