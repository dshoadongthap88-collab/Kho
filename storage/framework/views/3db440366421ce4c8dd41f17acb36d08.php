...
<body class="p-8">
    <div class="max-w-4xl mx-auto">
        <div class="mb-4 no-print flex justify-between items-center bg-white p-2 rounded shadow">
            <h1 class="text-xl font-bold text-gray-800">In <?php echo e($tickets->count()); ?> Phiếu Bảo Dưỡng</h1>
            ...
            <div class="bg-white p-10 shadow-sm border border-gray-200 rounded-lg mb-8 page-break">
                ...
                <div class="flex justify-between items-start border-b-2 border-slate-800 pb-4 mb-6">
                    ...
                    <div class="text-right">
                        <div class="text-lg font-bold text-sky-800">Số: <?php echo e($ticket->ticket_code); ?></div>
                        <div class="text-sm">Ngày in: <?php echo e(now()->format('d/m/Y')); ?></div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-2 mb-8 text-sm">
                    <div>
                        <table class="w-full">
                            <tr><td class="py-1 font-bold w-1/3">Thiết bị:</td><td class="py-1 uppercase text-sky-800 font-bold"><?php echo e($ticket->asset->name ?? 'N/A'); ?></td></tr>
                            <tr><td class="py-1 font-bold">Mã tài sản:</td><td class="py-1 font-mono font-medium"><?php echo e($ticket->asset->asset_code ?? 'N/A'); ?></td></tr>
                            <tr><td class="py-1 font-bold">Tài xế/Vận hành:</td><td class="py-1"><?php echo e($ticket->staff_name ?? '.........................................'); ?></td></tr>
                        </table>
                    </div>
                    <div>
                        <table class="w-full">
                            <tr><td class="py-1 font-bold w-1/3">Ngày bảo dưỡng:</td><td class="py-1"><?php echo e($ticket->maintenance_date ? \Carbon\Carbon::parse($ticket->maintenance_date)->format('d/m/Y') : '.....................'); ?></td></tr>
                            <tr><td class="py-1 font-bold">Cấp bảo dưỡng:</td><td class="py-1 font-bold text-red-600"><?php echo e($ticket->maintenance_rule_id ?? 'N/A'); ?></td></tr>
                            <tr><td class="py-1 font-bold">Giờ máy (ODO):</td><td class="py-1 font-bold"><?php echo e(number_format($ticket->maintenance_odo)); ?></td></tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <table class="w-full border-collapse border border-slate-300 text-sm">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bom && $bom->items->count() > 0): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bom->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr>
                                        <td class="border border-slate-300 px-3 py-2 text-center"><?php echo e($i + 1); ?></td>
                                        <td class="border border-slate-300 px-3 py-2 font-medium"><?php echo e($item->product->name ?? 'N/A'); ?></td>
                                        <td class="border border-slate-300 px-3 py-2 text-center"><?php echo e($item->product->unit ?? 'Cái'); ?></td>
                                        <td class="border border-slate-300 px-3 py-2 text-center font-bold"><?php echo e(number_format($item->quantity, 1)); ?></td>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($j = 1; $j <= 3; $j++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr>
...
<?php /**PATH D:\Project\resources\views\warehouse\maintenance\print-tickets.blade.php ENDPATH**/ ?>