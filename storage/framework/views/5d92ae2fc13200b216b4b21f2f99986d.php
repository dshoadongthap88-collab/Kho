<div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFormOpen): ?>
        <div class="bg-white rounded-xl shadow-lg border border-slate-200 mb-6 animate-in slide-in-from-top-2 duration-300">
            <div class="p-2 border-b border-slate-200 bg-indigo-50 rounded-t-xl">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="p-2 border-t border-slate-100 bg-slate-50 flex justify-end gap-3 rounded-b-xl">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="p-2 border-b border-slate-200 bg-slate-50 flex flex-wrap justify-between items-center gap-2">
            ...
            <table class="w-full text-left text-sm text-slate-600">
                <thead class="bg-slate-800 text-xs uppercase font-black text-white tracking-widest">
                    <tr>
                        ...
                        <th class="px-2 py-2">Tên Thiết Bị / Máy</th>
                        <th class="px-2 py-2">Bộ phận</th>
                        <th class="px-2 py-2">Model/Serial</th>
                        <th class="px-2 py-2 text-center">Trạng thái</th>
                        <th class="px-2 py-2">Dự án</th>
                        <th class="px-2 py-2 text-center">Kho QL</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-indigo-50/30 transition group <?php echo e(in_array($asset->id, $selectedIds) ? 'bg-indigo-50' : ''); ?>">
                        ...
                        <td class="px-2 py-1.5 font-black text-indigo-700"><?php echo e($asset->asset_code); ?></td>
                        ...
                        <td class="px-2 py-1.5 font-semibold text-slate-700"><?php echo e($asset->department ?: '-'); ?></td>
                        ...
                        <td class="px-2 py-1.5 font-semibold text-slate-700"><?php echo e(optional($asset->house)->name ?: '-'); ?></td>
                        <td class="px-2 py-1.5 text-center font-bold text-slate-700"><?php echo e($asset->management_unit ?: '-'); ?></td>
                        <td class="px-2 py-1.5 text-center">
