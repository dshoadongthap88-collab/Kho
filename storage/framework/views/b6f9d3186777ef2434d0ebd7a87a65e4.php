                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-indigo-50/50 transition-colors cursor-pointer <?php echo e(session('edited_user_id') == $user->id ? 'bg-indigo-50' : ''); ?>" 
                            ...
                            <td class="px-2 py-1.5 font-medium text-gray-800"><?php echo e($user->code); ?></td>
                            ...
                            <td class="px-2 py-1.5 text-gray-600"><?php echo e($user->role === 'admin' ? 'Quản trị viên' : ($user->role === 'staff' ? 'Nhân viên' : 'Xem')); ?></td>
                            <td class="px-2 py-1.5 text-gray-600"><?php echo e($user->department ?? '-'); ?></td>
                            <td class="px-2 py-1.5 text-gray-600"><?php echo e($user->username ?? $user->email ?? '-'); ?></td>
