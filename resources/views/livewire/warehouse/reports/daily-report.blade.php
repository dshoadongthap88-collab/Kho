<div>
    <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex space-x-4">
            ...
            <a href="{{ route('warehouse.reports.daily.print', ['date' => $date]) }}" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="flex items-center justify-between py-3 border-b">
                ...
                <span class="text-xl font-bold text-gray-800">{{ $reportData['totalStockOutOrders'] }}</span>
            </div>
            <div class="flex items-center justify-between py-3 border-b">
                <span class="text-gray-600">Số mã tài sản (dự án) đã xuất</span>
                <span class="text-xl font-bold text-gray-800">{{ $reportData['assetExportCount'] }}</span>
            </div>
            <div class="flex items-center justify-between py-3">
                <span class="text-gray-600">Số mã vật tư (dự án) đã xuất</span>
                <span class="text-xl font-bold text-gray-800">{{ $reportData['materialExportCount'] }}</span>
            </div>
        </div>
    </div>
</div>
