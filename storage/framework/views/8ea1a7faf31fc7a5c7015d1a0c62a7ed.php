...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.warehouse-layout','data' => ['title' => 'Kiểm kê kho']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Kiểm kê kho']); ?>
...
[$__name, $__params] = $__split('warehouse.stock-count-form', []);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3095005214-0', $__key);
...
<?php endif; ?>
<?php /**PATH D:\Project\resources\views/warehouse/stock-count.blade.php ENDPATH**/ ?>