<div class="p-2 bg-white rounded-lg shadow-sm">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?php echo e(route('maintenance-boms.create')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">
            + Tạo BOM mới
        </a>
    </div>
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $boms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="border-b hover:bg-gray-50 transition">
                        <td class="p-3 font-medium text-blue-600"><?php echo e($bom->bom_code); ?></td>
                        <td class="p-3"><?php echo e($bom->asset->asset_code ?? 'N/A'); ?></td>
                        <td class="p-3"><?php echo e($bom->asset->name ?? 'N/A'); ?></td>
                        <td class="p-3"><span class="px-1.5 py-1 text-[11px] bg-indigo-100 text-indigo-700 rounded-full text-xs font-semibold"><?php echo e($bom->maintenance_level); ?></span></td>
                        <td class="p-3"><?php echo e($bom->cycle); ?></td>
                        <td class="p-3 font-bold"><?php echo e($bom->items->count()); ?></td>
                        <td class="p-3"><?php echo e($bom->creator->name ?? 'System'); ?></td>
                        <td class="p-3"><?php echo e($bom->created_at->format('d/m/Y')); ?></td>
                        <td class="p-3">
                            <a href="<?php echo e(route('maintenance-boms.edit', $bom->id)); ?>" class="text-blue-500 hover:underline">Sửa</a>
                        </td>
                    </tr>
...
<?php /**PATH D:\Project\resources\views\components\maintenance\maintenance-bom-list.blade.php ENDPATH**/ ?>