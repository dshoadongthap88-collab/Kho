            ...
            <tbody class="divide-y divide-gray-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recoveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recovery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="hover:bg-slate-50/80 transition group <?php echo e(in_array($recovery->id, $selectedIds) ? 'bg-indigo-50/50' : ''); ?>">
                        ...
                        <td class="px-4 py-3 font-mono font-black text-indigo-700"><?php echo e($recovery->recovery_number); ?></td>
                        <td class="px-4 py-3 font-mono text-xs text-gray-600"><?php echo e($recovery->stockOut?->code ?? '-'); ?></td>
                        <td class="px-4 py-3 font-mono text-xs"><?php echo e($recovery->product?->code ?? ''); ?></td>
                        <td class="px-4 py-3 text-gray-800"><?php echo e($recovery->product?->name ?? ''); ?></td>
                        <td class="px-4 py-3 text-center font-bold text-indigo-700"><?php echo e(number_format($recovery->quantity, 2)); ?></td>
                        <td class="px-4 py-3 text-center text-gray-600"><?php echo e($recovery->unit ?? '-'); ?></td>
                        <td class="px-4 py-3 text-gray-600"><?php echo e($recovery->recovery_date->format('d/m/Y')); ?></td>
                        <td class="px-4 py-3">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="hidden print:block fixed inset-0 bg-white z-[9999] w-full">
        ...
        ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $printList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recovery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div style="font-family: 'Times New Roman', serif; padding: 15mm; page-break-after: always; width: 100%;">
            ...
            <div class="mb-4 text-left">
                ...
                <div class="font-bold uppercase mt-1" style="font-size: 16px; color: black;">DỰ ÁN: <?php echo e(mb_strtoupper($recovery->stockOut?->project_name ?? (session('current_house', 1) == 2 ? 'HẬU NGHĨA' : (session('current_house', 1) == 3 ? 'CẦN GIỜ' : 'HÓC MÔN')), 'UTF-8')); ?></div>
            </div>
            ...
            <div class="text-center mb-6">
                ...
                <p class="italic text-[13px] mt-1">
                    Ngày <?php echo e($recovery->recovery_date->format('d')); ?>

                    tháng <?php echo e($recovery->recovery_date->format('m')); ?>

                    năm <?php echo e($recovery->recovery_date->format('Y')); ?>
            ...
            <div style="margin-bottom: 20px;" class="text-[14px]">
                <table class="w-full">
                    <tr>
                        ...
                        <td class="pb-1 font-mono uppercase font-semibold"><?php echo e($recovery->recovery_number); ?></td>
                    </tr>
                    <tr>
                        <td class="font-bold pb-1">Số PX:</td>
                        <td class="pb-1 font-mono"><?php echo e($recovery->stockOut?->code ?? 'Không liên kết'); ?></td>
                    </tr>
                    <tr>
                        <td class="font-bold pb-1">Trạng thái:</td>
                        <td class="pb-1 uppercase">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($recovery->status):
                                case ('pending'): ?> Đang chờ <?php break; ?>
                                <?php case ('approved'): ?> Đã duyệt <?php break; ?>
                                <?php case ('completed'): ?> Đã thu hồi <?php break; ?>
