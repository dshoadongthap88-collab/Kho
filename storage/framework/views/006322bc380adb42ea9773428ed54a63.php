                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $trackingList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 transition-colors <?php echo e($item['color'] === 'red' ? 'bg-red-50/30' : ($item['color'] === 'yellow' ? 'bg-yellow-50/30' : '')); ?>">
                            ...
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm text-gray-600 font-bold text-right"><?php echo e(number_format($item['cycle'])); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm text-gray-500 text-right"><?php echo e(number_format($item['last_hours'])); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-gray-900 text-right"><?php echo e(number_format($item['current_hours'])); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-blue-600 text-right"><?php echo e(number_format($item['target_hours'])); ?></td>
                            ...
                            <td class="px-2 py-1.5 whitespace-nowrap text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['color'] === 'red'): ?>
                                    <span class="px-1.5 py-1 text-[11px] inline-flex text-xs leading-4 font-extrabold rounded-md bg-red-100 text-red-800 border border-red-200 uppercase"><?php echo e($item['status']); ?></span>
                                <?php elseif($item['color'] === 'yellow'): ?>
                                    <span class="px-1.5 py-1 text-[11px] inline-flex text-xs leading-4 font-bold rounded-md bg-yellow-100 text-yellow-800 border border-yellow-200 uppercase"><?php echo e($item['status']); ?></span>
                                <?php else: ?>
                                    <span class="px-1.5 py-1 text-[11px] inline-flex text-xs leading-4 font-bold rounded-md bg-green-100 text-green-800 border border-green-200 uppercase"><?php echo e($item['status']); ?></span>
                            ...
                            <td class="px-2 py-1.5 whitespace-nowrap text-center text-sm font-medium">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['status'] === 'ĐẾN HẠN' || $item['status'] === 'SẮP ĐẾN'): ?>
                                    <a href="<?php echo e(route('warehouse.maintenance-plans')); ?>?create=1&asset=<?php echo e($item['asset_id']); ?>" class="text-white bg-indigo-600 hover:bg-indigo-700 px-1.5 py-1 text-[11px].5 rounded-md shadow-sm transition text-xs font-bold inline-block">Lên Kế Hoạch</a>
                                <?php else: ?>
