                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-gray-900"><?php echo e($log->asset->asset_code ?? ''); ?></td>
                            <td class="px-2 py-1.5 text-sm text-indigo-600 font-semibold"><?php echo e($log->asset->name ?? ''); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm text-gray-500 text-right"><?php echo e(number_format($log->old_odo)); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-gray-900 text-right"><?php echo e(number_format($log->new_odo)); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-green-600 text-right"><?php echo e(number_format($log->hours_diff)); ?> giờ</td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm text-gray-700"><?php echo e($log->operator); ?></td>
                            <td class="px-2 py-1.5 text-sm text-gray-500"><?php echo e(Str::limit($log->note, 30)); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-right text-sm font-medium">
                                <button wire:click="edit(<?php echo e($log->id); ?>)" class="text-indigo-600 hover:text-indigo-900 mx-1 p-1.5 rounded bg-indigo-50 hover:bg-indigo-100" title="Sửa">✏️</button>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['operator'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['hours_diff'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
