    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-md border border-slate-100 overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <div class="p-2 space-y-4">
                <a href="<?php echo e(route('hr.projects')); ?>" class="group flex items-start gap-2 p-2 rounded-xl border border-slate-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200">
                ...
                <a href="<?php echo e(route('hr.permissions')); ?>" class="group flex items-start gap-2 p-2 rounded-xl border border-slate-200 hover:border-purple-300 hover:bg-purple-50 transition-all duration-200">
