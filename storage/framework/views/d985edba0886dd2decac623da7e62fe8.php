...
<div id="print-content">
    ...
    <div style="margin-bottom: 20px;">
        ...
        <div style="font-weight: bold; font-size: 14px;">
            DỰ ÁN: <?php echo e(session('current_house', 1) == 2 ? 'HẬU NGHĨA' : (session('current_house', 1) == 3 ? 'CẦN GIỜ' : (session('current_house', 1) == 4 ? 'CẦN GIUỘC' : 'HÓC MÔN'))); ?>
    ...
    <div class="header" style="text-align: center; margin-bottom: 30px;">
        ...
        <div class="subtitle">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dateFrom === $dateTo): ?>
                Ngày báo cáo: <?php echo e(\Carbon\Carbon::parse($dateFrom)->format('d/m/Y')); ?>

            <?php else: ?>
                Kỳ báo cáo: Từ <?php echo e(\Carbon\Carbon::parse($dateFrom)->format('d/m/Y')); ?> đến <?php echo e(\Carbon\Carbon::parse($dateTo)->format('d/m/Y')); ?>
    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td width="30%" class="text-center font-bold"><?php echo e($reportData['totalStockInOrders']); ?></td>
            </tr>
            <tr>
                <td>Tổng số mã vật tư nhập kho:</td>
                <td class="text-center font-bold"><?php echo e($reportData['stockInCount']); ?></td>
            </tr>
            <tr>
                <td>Tổng số nhà cung cấp đã giao:</td>
                <td class="text-center font-bold"><?php echo e($reportData['supplierDeliveryCount']); ?></td>
            </tr>
        </tbody>
    </table>
        ...
        function initPrint() {
            ...
            if (isZalo) {
                ...
                setTimeout(() => {
                    ...
                    var opt = {
                      margin:       [15, 15, 15, 15],
                      filename:     'Bao_Cao_Tu_<?php echo e($dateFrom); ?>_Den_<?php echo e($dateTo); ?>.pdf',
