            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-200 text-sm">
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        <td class="p-2 font-medium text-slate-800"><?php echo e($category->name); ?></td>
                        <td class="p-2 text-slate-600"><?php echo e($category->description ?? "-"); ?></td>
                        <td class="p-2 font-medium text-indigo-600 text-center"><?php echo e($category->products_count); ?></td>
                        <td class="p-2">
