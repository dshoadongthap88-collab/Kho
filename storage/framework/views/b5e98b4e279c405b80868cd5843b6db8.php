            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-amber-50 transition-colors">
                        <td class="px-4 py-3 text-sm text-gray-500 font-bold"><?php echo e($index + 1); ?></td>
                        <td class="px-4 py-3 text-sm font-mono font-bold text-gray-900"><?php echo e($item['code']); ?></td>
                        <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($item['name']); ?></td>
                        <td class="px-4 py-3 text-sm text-center text-gray-500"><?php echo e($item['unit']); ?></td>
                        <td class="px-4 py-3 text-sm text-center font-bold text-amber-700"><?php echo e(number_format($item['total_qty'], 2)); ?></td>
                        <td class="px-4 py-3 text-sm text-center text-gray-600"><?php echo e($item['total_orders']); ?></td>
                        <td class="px-4 py-3 text-sm text-sky-700 font-medium"><?php echo e($item['top_project']); ?></td>
                        <td class="px-4 py-3 text-center">
                            <button wire:click="openCreateFromProduct(<?php echo e($item['product_id']); ?>, <?php echo e($item['house_id'] ?? 'null'); ?>)" class="text-xs bg-amber-100 text-amber-700 hover:bg-amber-200 px-2 py-1 rounded font-bold transition-colors">
                                + Đề xuất
                            </button>
                        </td>
                    </tr>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-red-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($item['name']); ?></td>
                        <td class="px-4 py-3 text-sm text-center text-gray-500"><?php echo e($item['unit']); ?></td>
                        <td class="px-4 py-3 text-sm text-center font-bold text-red-600"><?php echo e(number_format($item['current_qty'], 2)); ?></td>
                        <td class="px-4 py-3 text-sm text-center text-gray-600"><?php echo e(number_format($item['min_stock'], 2)); ?></td>
                        ...
                        <td class="px-4 py-3 text-sm text-sky-700 font-medium"><?php echo e($item['project']); ?></td>
                        <td class="px-4 py-3 text-center">
                            <button wire:click="openCreateFromProduct(<?php echo e($item['product_id']); ?>, <?php echo e($item['house_id']); ?>, <?php echo e($item['shortage']); ?>)" class="text-xs bg-red-100 text-red-700 hover:bg-red-200 px-2 py-1 rounded font-bold transition-colors">
                                + Đề xuất mua
                            </button>
                        </td>
                    </tr>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-4 py-3 text-sm text-gray-500">#<?php echo e($plan->id); ?></td>
                        <td class="px-4 py-3 text-sm font-mono font-bold text-gray-900"><?php echo e($plan->product->code ?? 'N/A'); ?></td>
                        <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($plan->product->name ?? 'N/A'); ?></td>
                        <td class="px-4 py-3 text-sm text-center font-bold text-amber-700"><?php echo e(number_format($plan->proposed_quantity, 2)); ?></td>
                        <td class="px-4 py-3 text-sm text-center text-green-600 font-bold"><?php echo e(number_format($plan->delivered_quantity, 2)); ?></td>
                        ...
                        <td class="px-4 py-3 text-sm text-center text-gray-500"><?php echo e($plan->expected_delivery_date ? $plan->expected_delivery_date->format('d/m/Y') : '-'); ?></td>
                        <td class="px-4 py-3 text-sm text-center">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-500 max-w-[150px] truncate" title="<?php echo e($plan->notes); ?>"><?php echo e($plan->notes ?? '-'); ?></td>
