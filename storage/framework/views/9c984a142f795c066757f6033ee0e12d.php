                ...
                <tr class="bg-slate-50 border-b border-slate-200 text-slate-500 uppercase text-[11px] font-black tracking-widest">
                    <th class="px-2 py-2 w-10 text-center no-print">
                        <input type="checkbox" wire:click="toggleSelectAll" 
                               <?php echo e(count($selectedIds) === ($activeTab === 'materials' ? $products->total() : $equipments->total()) && ($activeTab === 'materials' ? $products->total() : $equipments->total()) > 0 ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="print-only print-container" style="font-family: 'Times New Roman', Times, serif;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <p style="font-size: 16px; font-weight: bold; margin: 4px 0;">DỰ ÁN: <?php echo e(\App\Models\Project::find(auth()->user()->current_house_id)->name ?? '...'); ?></p>
        </div>
