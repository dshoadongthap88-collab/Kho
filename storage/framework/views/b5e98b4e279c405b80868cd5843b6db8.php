<div class="space-y-4">
    ...
    <div class="flex gap-1 bg-white rounded-xl shadow-sm border border-gray-100 p-1.5">
        <button wire:click="switchTab('top-usage')" class="px-4 py-2 rounded-lg text-sm font-bold transition-all <?php echo e($activeTab === 'top-usage' ? 'bg-amber-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100'); ?>">
            📊 Top Vật Tư Sử Dụng (60 ngày)
        </button>
        <button wire:click="switchTab('low-stock')" class="px-4 py-2 rounded-lg text-sm font-bold transition-all <?php echo e($activeTab === 'low-stock' ? 'bg-red-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100'); ?>">
            ⚠️ Tồn Dưới Mức Tối Thiểu
        </button>
        <button wire:click="switchTab('proposals')" class="px-4 py-2 rounded-lg text-sm font-bold transition-all <?php echo e($activeTab === 'proposals' ? 'bg-sky-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100'); ?>">
            📋 Đề Xuất Mua Hàng (CRUD)
        </button>
    </div>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'top-usage'): ?>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->topUsageData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="hover:bg-amber-50 transition-colors">
                        <td class="px-2 py-1.5 text-sm text-gray-500 font-bold"><?php echo e($index + 1); ?></td>
                        <td class="px-2 py-1.5 text-sm font-mono font-bold text-gray-900"><?php echo e($item['code']); ?></td>
                        <td class="px-2 py-1.5 text-sm text-gray-700"><?php echo e($item['name']); ?></td>
                        <td class="px-2 py-1.5 text-sm text-center text-gray-500"><?php echo e($item['unit']); ?></td>
                        <td class="px-2 py-1.5 text-sm text-center font-bold text-amber-700"><?php echo e(number_format($item['total_qty'], 2)); ?></td>
                        <td class="px-2 py-1.5 text-sm text-center text-gray-600"><?php echo e($item['total_orders']); ?></td>
                        <td class="px-2 py-1.5 text-sm text-sky-700 font-medium"><?php echo e($item['top_project']); ?></td>
                        <td class="px-2 py-1.5 text-center">
                            <button wire:click="openCreateFromProduct(<?php echo e($item['product_id']); ?>, <?php echo e($item['house_id'] ?? 'null'); ?>)" class="text-xs bg-amber-100 text-amber-700 hover:bg-amber-200 px-1.5 py-1 text-[11px] rounded font-bold transition-colors">
                                + Đề xuất
                            </button>
                        </td>
                    </tr>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'low-stock'): ?>
    <div class="bg-white rounded-xl shadow-sm border border-red-100 overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->lowStockData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="hover:bg-red-50 transition-colors">
                        <td class="px-2 py-1.5 text-sm text-gray-500 font-bold"><?php echo e($index + 1); ?></td>
                        <td class="px-2 py-1.5 text-sm font-mono font-bold text-gray-900"><?php echo e($item['code']); ?></td>
                        <td class="px-2 py-1.5 text-sm text-gray-700"><?php echo e($item['name']); ?></td>
                        <td class="px-2 py-1.5 text-sm text-center text-gray-500"><?php echo e($item['unit']); ?></td>
                        <td class="px-2 py-1.5 text-sm text-center font-bold text-red-600"><?php echo e(number_format($item['current_qty'], 2)); ?></td>
                        <td class="px-2 py-1.5 text-sm text-center text-gray-600"><?php echo e(number_format($item['min_stock'], 2)); ?></td>
                        <td class="px-2 py-1.5 text-sm text-center">
                            <span class="bg-red-100 text-red-700 px-2 py-0.5 rounded-full text-xs font-bold">-<?php echo e(number_format($item['shortage'], 2)); ?></span>
                        </td>
                        <td class="px-2 py-1.5 text-sm text-sky-700 font-medium"><?php echo e($item['project']); ?></td>
                        <td class="px-2 py-1.5 text-center">
                            <button wire:click="openCreateFromProduct(<?php echo e($item['product_id']); ?>, <?php echo e($item['house_id']); ?>, <?php echo e($item['shortage']); ?>)" class="text-xs bg-red-100 text-red-700 hover:bg-red-200 px-1.5 py-1 text-[11px] rounded font-bold transition-colors">
                                + Đề xuất mua
                            </button>
                        </td>
                    </tr>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'proposals'): ?>
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-2 py-1.5 text-sm text-gray-500">#<?php echo e($plan->id); ?></td>
                        <td class="px-2 py-1.5 text-sm font-mono font-bold text-gray-900"><?php echo e($plan->product->code ?? 'N/A'); ?></td>
                        <td class="px-2 py-1.5 text-sm text-gray-700"><?php echo e($plan->product->name ?? 'N/A'); ?></td>
                        <td class="px-2 py-1.5 text-sm text-center font-bold text-amber-700"><?php echo e(number_format($plan->proposed_quantity, 2)); ?></td>
                        <td class="px-2 py-1.5 text-sm text-center text-green-600 font-bold"><?php echo e(number_format($plan->delivered_quantity, 2)); ?></td>
                        <td class="px-2 py-1.5 text-sm text-sky-700 font-medium">
                            <?php $proj = \App\Models\Project::find($plan->house_id); ?>
                            <?php echo e($proj->name ?? 'N/A'); ?>

                        </td>
                        <td class="px-2 py-1.5 text-sm text-center text-gray-500"><?php echo e($plan->expected_delivery_date ? $plan->expected_delivery_date->format('d/m/Y') : '-'); ?></td>
                        <td class="px-2 py-1.5 text-sm text-center">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($plan->status):
                                case ('pending'): ?>
                                ...
                                <?php case ('cancelled'): ?>
                                    ...
                                    <?php break; ?>
                                <?php default: ?>
                                    <span class="px-2 py-0.5 rounded-full text-xs font-bold bg-gray-100 text-gray-700"><?php echo e($plan->status); ?></span>
                            <?php endswitch; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="px-2 py-1.5 text-sm text-gray-500 max-w-[150px] truncate" title="<?php echo e($plan->notes); ?>"><?php echo e($plan->notes ?? '-'); ?></td>
                        <td class="px-2 py-1.5 text-right text-sm space-x-2">
                            <button wire:click="editProposal(<?php echo e($plan->id); ?>)" class="text-indigo-600 hover:text-indigo-900 font-bold">Sửa</button>
                            <button onclick="confirm('Bạn có chắc muốn xóa đề xuất #<?php echo e($plan->id); ?>?') || event.stopImmediatePropagation()" wire:click="deleteProposal(<?php echo e($plan->id); ?>)" class="text-red-600 hover:text-red-900 font-bold">Xóa</button>
                        </td>
                    </tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <tr>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proposals->hasPages()): ?>
            ...
            <form wire:submit.prevent="saveProposal">
                <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-amber-50">
                    <h3 class="text-lg font-bold text-amber-900">
                        <?php echo e($proposal_id ? '✏️ Sửa Đề Xuất Mua Hàng #'.$proposal_id : '➕ Tạo Đề Xuất Mua Hàng Mới'); ?>
                ...
                <div class="px-6 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['proposal_house_id'];
                    ...
                    <div>
                        ...
                        <select wire:model="proposal_product_id" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-amber-500 focus:border-amber-500 text-sm">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $allProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($product->id); ?>">[<?php echo e($product->code); ?>] <?php echo e($product->name); ?> (<?php echo e($product->unit); ?>)</option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['proposal_product_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['proposal_quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['proposal_notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-2">
                    ...
                    <button type="submit" class="px-4 py-2 bg-amber-600 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white hover:bg-amber-700">
                        <?php echo e($proposal_id ? 'Lưu thay đổi' : 'Tạo Đề Xuất'); ?>
...
<?php /**PATH D:\Project\resources\views\livewire\hr\purchase-center.blade.php ENDPATH**/ ?>