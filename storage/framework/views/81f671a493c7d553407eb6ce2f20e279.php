        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody>
                ...
                <tr class="border-b border-slate-100 hover:bg-slate-50">
                    <td class="p-4 text-slate-800 font-medium"><?php echo e($project->code ?? '-'); ?></td>
                    <td class="p-4 font-bold text-indigo-700"><?php echo e($project->name); ?></td>
                    <td class="p-4">
                    ...
                    <td class="p-4 text-slate-600 text-sm"><?php echo e($project->description ?? '-'); ?></td>
                    <td class="p-4 text-right">
                        <button wire:click="edit(<?php echo e($project->id); ?>)" class="text-blue-600 hover:text-blue-800 font-bold text-sm mr-3">Sửa</button>
                        <button wire:click="delete(<?php echo e($project->id); ?>)" onclick="confirm('Bạn có chắc chắn muốn xóa dự án này?') || event.stopImmediatePropagation()" class="text-red-600 hover:text-red-800 font-bold text-sm">Xóa</button>
                    </td>
                </tr>
