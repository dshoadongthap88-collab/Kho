                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <tr class="<?php echo e($rowClass); ?> transition-colors">
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-gray-900"><?php echo e($plan->plan_code); ?></td>
                            ...
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-gray-800"><?php echo e($plan->category); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-right text-gray-900"><?php echo e(number_format($currentVal)); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-right text-indigo-600"><?php echo e(number_format($plan->maintenance_odo)); ?></td>
                            ...
                            <td class="px-2 py-1.5 whitespace-nowrap text-right text-sm font-medium">
                                <button wire:click="markAsCompleted(<?php echo e($plan->id); ?>)" class="text-green-700 hover:text-green-900 mx-2 bg-green-100 border border-green-200 px-1.5 py-1 text-[11px].5 rounded-lg shadow-sm" title="Đã hoàn thành">Đã bảo dưỡng ✅</button>
                            </td>
                        </tr>
