<div>
    <div class="bg-indigo-900 text-white shadow relative z-20 flex justify-between items-center px-6 py-4">
        ...
        <a href="<?php echo e(route('hr.dashboard')); ?>" class="w-10 h-10 rounded-full hover:bg-red-500 bg-indigo-800 flex items-center justify-center transition-colors shadow focus:outline-none" title="Đóng">
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-indigo-50/50 transition-colors">
                            <td class="px-2 py-1.5 text-gray-500"><?php echo e($module->id); ?></td>
                            <td class="px-2 py-1.5 font-medium text-indigo-900"><?php echo e($module->group_name); ?></td>
                            <td class="px-2 py-1.5 text-gray-600 font-mono text-xs"><?php echo e($module->route_name); ?></td>
                            <td class="px-2 py-1.5 text-gray-800"><?php echo e($module->label); ?></td>
                            <td class="px-2 py-1.5">
                                <button wire:click="toggleActive(<?php echo e($module->id); ?>)" class="px-1.5 py-1 text-[11px] rounded text-xs font-bold <?php echo e($module->is_active ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'); ?>">
                                    <?php echo e($module->is_active ? "Đang bật" : "Đã tắt"); ?>

                                </button>
                            </td>
                            <td class="px-2 py-1.5 text-center">
                                <button wire:click="edit(<?php echo e($module->id); ?>)" class="text-blue-500 hover:text-blue-700 p-1 rounded hover:bg-blue-50 transition-colors" title="Sửa">
                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                                <?php echo e($moduleId ? "Sửa Module" : "Thêm Module Mới"); ?>
                            ...
                            <div class="mt-4 space-y-4">
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ["group_name"];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ["route_name"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH D:\Project\resources\views\livewire\hr\system-module-manager.blade.php ENDPATH**/ ?>