    ...
    <div class="mb-8 p-6 bg-gradient-to-r from-purple-700 to-indigo-800 rounded-2xl shadow-xl text-white relative overflow-hidden">
        ...
        <div class="relative z-10 mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
                ...
                <div class="text-3xl font-bold"><?php echo e($stats['total_projects']); ?></div>
            </div>
            <div class="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-md border border-slate-100 overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <div class="p-6 space-y-4">
                <a href="<?php echo e(route('hr.projects')); ?>" class="group flex items-start gap-4 p-4 rounded-xl border border-slate-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200">
                ...
                <a href="<?php echo e(route('hr.permissions')); ?>" class="group flex items-start gap-4 p-4 rounded-xl border border-slate-200 hover:border-purple-300 hover:bg-purple-50 transition-all duration-200">
        ...
        <div class="bg-white rounded-2xl shadow-md border border-slate-100 overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <div class="p-6">
                <a href="<?php echo e(route('hr.global-report')); ?>" class="block relative overflow-hidden rounded-xl border border-slate-200 hover:border-emerald-300 group transition-all duration-200">
...
<?php /**PATH D:\Project\resources\views\livewire\hr\hr-dashboard.blade.php ENDPATH**/ ?>