                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-indigo-50/50 transition-colors">
                            <td class="px-4 py-3 text-gray-500"><?php echo e($module->id); ?></td>
                            <td class="px-4 py-3 font-medium text-indigo-900"><?php echo e($module->group_name); ?></td>
                            <td class="px-4 py-3 text-gray-600 font-mono text-xs"><?php echo e($module->route_name); ?></td>
                            <td class="px-4 py-3 text-gray-800"><?php echo e($module->label); ?></td>
                            <td class="px-4 py-3">
                                <button wire:click="toggleActive(<?php echo e($module->id); ?>)" class="px-2 py-1 rounded text-xs font-bold <?php echo e($module->is_active ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'); ?>">
