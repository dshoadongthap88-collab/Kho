                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-indigo-600"><?php echo e($plan->plan_code); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-900 font-semibold"><?php echo e($plan->asset->asset_code ?? ''); ?><br><span class="text-xs font-normal text-gray-500"><?php echo e($plan->asset->name ?? ''); ?></span></td>
                            <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($plan->category); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo e($plan->expected_date ? \Carbon\Carbon::parse($plan->expected_date)->format('d/m/Y') : '—'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-right"><?php echo e(number_format($plan->current_odo)); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900 text-right"><?php echo e(number_format($plan->maintenance_odo)); ?></td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($plan->status, ['cho_chuan_bi_vat_tu', 'pending', 'thieu_vat_tu'])): ?>
                                    <button wire:click="checkInventory(<?php echo e($plan->id); ?>)" class="text-white bg-blue-600 hover:bg-blue-700 px-2 py-1.5 rounded mr-1" title="Kiểm tra tồn kho vật tư">🔍 Kiểm tra kho</button>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan->status === 'san_sang_xuat'): ?>
                                    <button wire:click="createStockOut(<?php echo e($plan->id); ?>)" class="text-white bg-green-600 hover:bg-green-700 px-2 py-1.5 rounded mr-1" title="Tạo phiếu xuất kho">📦 Xuất kho</button>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
