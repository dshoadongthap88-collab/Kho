            ...
            <tbody class="divide-y divide-gray-100 italic-rows">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-2 py-1.5">
                        <div class="text-xs font-semibold text-gray-800"><?php echo e($tx->product->name ?? ''); ?></div>
                    ...
                    <td class="px-2 py-1.5 text-[10px] text-gray-400 leading-tight"><?php echo e(Str::limit($tx->note, 50)); ?></td>
                </tr>
