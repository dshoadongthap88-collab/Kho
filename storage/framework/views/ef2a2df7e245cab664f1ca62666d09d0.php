                ...
                <div class="hidden md:flex items-center gap-1">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 mt-0 w-56 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-left -translate-y-2 group-hover:translate-y-0 text-left z-[100]">
                            <a href="<?php echo e(route('warehouse.product-catalog', ['activeTab' => 'materials'])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-slate-100">DANH MỤC VẬT TƯ</a>
                            <a href="<?php echo e(route('warehouse.product-catalog', ['activeTab' => 'equipments'])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-slate-100 border-t border-slate-50">DANH MỤC THIẾT BỊ</a>
                        </div>
                    </div>
