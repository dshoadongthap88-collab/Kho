                                ...
                                <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'transfer-'.e($transfer->id).''; ?>wire:key="transfer-<?php echo e($transfer->id); ?>" class="hover:bg-indigo-50/30 transition-all" :class="selected.includes('<?php echo e($transfer->id); ?>') ? 'bg-indigo-50/50' : ''">
                                    <td class="px-5 py-4 cursor-pointer hover:bg-indigo-100 transition-colors group">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="font-mono font-black text-indigo-700 text-xs tracking-tight group-hover:text-indigo-900 cursor-pointer" wire:click="viewDetail(<?php echo e($transfer->id); ?>)">
                                    ...
                                    <td class="px-5 py-4">
                                        ...
                                        <?php elseif($transfer->status === 'reverted'): ?>
            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-2 sm:pb-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->selectedTransferDetail->status === 'rejected' && $this->selectedTransferDetail->reject_reason): ?>
                            <div class="mb-6">
                                <p class="text-[10px] uppercase font-bold text-rose-400 mb-1">Lý do từ chối</p>
                                <p class="text-sm text-rose-700 italic bg-rose-50 p-3 rounded-lg border border-rose-100"><?php echo e($this->selectedTransferDetail->reject_reason); ?></p>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 flex flex-col gap-3" x-data="{ showReject: false }">
                        ...
                        <div class="flex justify-end gap-3 w-full" x-show="!showReject">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->selectedTransferDetail->status === 'pending' && $this->selectedTransferDetail->to_project_id == $currentHouse): ?>
                                ...
                                <button type="button" wire:click="confirmTransfer(<?php echo e($this->selectedTransferDetail->id); ?>)" class="inline-flex justify-center items-center px-4 py-2 text-sm font-bold text-white bg-green-600 border border-green-600 rounded-md shadow-sm hover:bg-green-700 focus:outline-none">
                                    ✅ Xác nhận nhận hàng
                                </button>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->selectedTransferDetail->status === 'completed' && $this->selectedTransferDetail->to_project_id == $currentHouse): ?>
                                <button type="button" wire:click="revertTransfer(<?php echo e($this->selectedTransferDetail->id); ?>)" onclick="return confirm('Hành động này sẽ TRỪ lại tồn kho của bạn và CỘNG lại cho kho gửi. Bạn có chắc chắn?')" class="inline-flex justify-center items-center px-4 py-2 text-sm font-bold text-orange-600 bg-white border border-orange-600 rounded-md shadow-sm hover:bg-orange-50 focus:outline-none">
                                    ↩️ Hủy nhập (Hoàn tác)
                                </button>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
