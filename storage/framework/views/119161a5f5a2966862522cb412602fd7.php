<div>
    ...
    <div class="relative flex items-start gap-2">
        ...
        <div class="sidebar-toolbar sticky top-24 hidden md:flex flex-col gap-3 no-print">
            ...
            <a href="<?php echo e(route('warehouse.inventory')); ?>" class="group flex flex-col items-center justify-center w-16 h-16 bg-white border border-slate-200 rounded-xl shadow-sm hover:bg-slate-50 transition-all duration-200" title="Quay lại">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden printable-area">
                <div class="bg-slate-50 border-b border-slate-200 px-6 py-4 flex items-center justify-between">
                    ...
                    <div class="hidden print-only text-right">
                        <p class="text-sm font-bold text-slate-600">Số phiếu: SO-<?php echo e(date('Ymd')); ?>-XXXX</p>
                        <p class="text-xs text-slate-400">Ngày in: <?php echo e(date('d/m/Y H:i')); ?></p>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <datalist id="customers_list">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($customer->name); ?>"></option>
                            ...
                            <tbody class="divide-y divide-slate-100">
                                ...
                                <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'item-'.e($index).''; ?>wire:key="item-<?php echo e($index); ?>" class="hover:bg-slate-50/50 transition duration-150 <?php echo e(!$item['is_printed'] ? 'no-print' : ''); ?>">
                                    <td class="px-3 py-4 text-center no-print">
                                        <input type="checkbox" wire:model="items.<?php echo e($index); ?>.is_printed" class="rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 h-4 w-4">
                                    </td>
                                    <td class="px-4 py-4">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($items[$index]['brand']) && $items[$index]['brand']): ?>
                                            <p class="text-[10px] text-slate-400 mt-1 uppercase font-bold tracking-tight px-1 no-print">Hiệu: <?php echo e($items[$index]['brand']); ?></p>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-500 text-xs mt-1 no-print"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <td class="px-4 py-4">
                                        <input type="text" wire:model="items.<?php echo e($index); ?>.warehouse_location" list="location_list_<?php echo e($index); ?>"
                                    ...
                                    <td class="px-4 py-4">
                                        <input type="number" wire:model.live="items.<?php echo e($index); ?>.quantity" step="0.0001" min="0"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="flex justify-end items-center gap-2 no-print">
                        <a href="<?php echo e(route('warehouse.inventory')); ?>" class="px-6 py-2.5 border border-slate-300 rounded-xl text-slate-600 font-semibold hover:bg-slate-50 transition duration-150 shadow-sm">
                            Hủy bỏ
                        </a>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showBatchModal): ?>
            ...
            <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full overflow-hidden border border-slate-200 animate-in fade-in zoom-in duration-200">
                ...
                <div class="p-2">
                    <p class="mb-4 text-sm text-slate-500">
                        Hệ thống tìm thấy <strong><?php echo e(count($availableBatches)); ?> lô hàng</strong> của sản phẩm này. Vui lòng chọn một lô để xuất kho:
                    </p>
                    ...
                    <div class="overflow-x-auto border border-slate-100 rounded-xl">
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-slate-50">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $availableBatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="hover:bg-indigo-50/30 transition duration-150">
                                        <td class="px-4 py-4 font-semibold text-slate-700"><?php echo e($batch['batch_number'] ?: 'N/A'); ?></td>
                                        <td class="px-4 py-4 text-slate-600">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($batch['expiry_date']): ?>
                                                <span class="<?php echo e(\Carbon\Carbon::parse($batch['expiry_date'])->isPast() ? 'text-red-500 font-bold' : ''); ?>">
                                                    <?php echo e(\Carbon\Carbon::parse($batch['expiry_date'])->format('d/m/Y')); ?>
                                        ...
                                        <td class="px-4 py-4 text-slate-600">
                                            <span class="px-1.5 py-1 text-[11px] bg-slate-100 rounded text-xs"><?php echo e($batch['warehouse_location'] ?: 'Chưa rõ'); ?></span>
                                        </td>
                                        <td class="px-4 py-4 text-right">
                                            <span class="font-bold text-indigo-600"><?php echo e(number_format($batch['stock'], 4)); ?></span>
                                        </td>
                                        <td class="px-4 py-4 text-center">
                                            <button wire:click="selectBatch(<?php echo e($index); ?>)" class="bg-indigo-600 text-white px-1.5 py-1 text-[11px] rounded-lg text-xs font-bold hover:bg-indigo-700 transition">
                                                Chọn lô
                                            </button>
                                        </td>
                                    </tr>
...
<?php /**PATH D:\Project\resources\views\livewire\warehouse\stock-out-form-backup.blade.php ENDPATH**/ ?>