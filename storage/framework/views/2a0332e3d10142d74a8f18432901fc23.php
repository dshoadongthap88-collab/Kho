<div class="px-4 py-6" x-data="{ tab: <?php if ((object) ('activeTab') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('activeTab'->value()); ?>')<?php echo e('activeTab'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('activeTab'); ?>')<?php endif; ?>, selectedWarningLow: [], selectedWarningHigh: [], selectedRows: [] }">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
            <div class="bg-white rounded-xl p-4 shadow-sm border border-slate-100 flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-slate-800 mt-1"><?php echo e($projects->count()); ?></h3>
                </div>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-slate-100 flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-slate-800 mt-1"><?php echo e($totalUsers); ?></h3>
                </div>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-slate-100 flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-slate-800 mt-1"><?php echo e(number_format($totalOrdersAllProjects)); ?></h3>
                </div>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-slate-100 flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-slate-800 mt-1"><?php echo e(number_format($totalItemsAllProjects)); ?></h3>
                </div>
    ...
    <div x-show="tab === 'inventory_warnings'" style="display: none;" class="print-section">
                        ...
                        <ul class="text-sm text-amber-900 space-y-2 max-h-[500px] overflow-y-auto px-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $lowStockProducts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <li class="flex items-start gap-3 hover:bg-amber-100 p-2 rounded transition-colors">
                                    <input type="checkbox" value="<?php echo e($index); ?>" x-model="selectedWarningLow" class="row-cb-low mt-1 rounded border-gray-300 text-amber-600 focus:ring-amber-500">
                                    <div>
                        ...
                        <ul class="text-sm text-rose-900 space-y-2 max-h-[500px] overflow-y-auto px-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $highStockProducts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <li class="flex items-start gap-3 hover:bg-rose-100 p-2 rounded transition-colors">
                                    <input type="checkbox" value="<?php echo e($index); ?>" x-model="selectedWarningHigh" class="row-cb-high mt-1 rounded border-gray-300 text-rose-600 focus:ring-rose-500">
                                    <div>
                                        <b class="text-base"><?php echo e($item->name); ?></b> <span class="text-gray-600">(<?php echo e($item->code); ?>)</span>
        ...
        <div class="hidden print:block w-full text-black">
            <div class="text-center mb-6">
                ...
                <p class="mt-1 text-sm">Ngày in: <?php echo e(now()->format('d/m/Y H:i')); ?></p>
            </div>

            <!-- Table for Low Stock -->
            <div :class="{ 'hidden': selectedWarningHigh.length > 0 && selectedWarningLow.length === 0 }" class="mb-4">
                <p class="font-bold text-sm italic mb-1">Dự Án: <?php echo e($warningProject ? $projects->where('id', $warningProject)->first()->name : 'Tất cả các kho'); ?></p>
    ...
    <div x-show="tab === 'stock_out_details'" style="display: none;" class="print-section">
        ...
        <div class="hidden print:block text-center mb-8">
            ...
            <p class="mt-2 text-gray-600">Dự án: <?php echo e($selectedProject ? $projects->where('id', $selectedProject)->first()->name : 'Tất cả'); ?></p>
            <p class="text-gray-600">Thời gian: <?php echo e($startDate ? \Carbon\Carbon::parse($startDate)->format('d/m/Y') : 'Từ đầu'); ?> - <?php echo e($endDate ? \Carbon\Carbon::parse($endDate)->format('d/m/Y') : 'Nay'); ?></p>
        </div>
            ...
            <div class="overflow-x-auto print-overflow-visible">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100 text-sm">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $stockOutDetails ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr :class="{ 'print:hidden': selectedRows.length > 0 && !selectedRows.includes('<?php echo e($index); ?>') }" class="hover:bg-slate-50 transition-colors">
                                <td class="p-3 text-center print:hidden">
                                    <input type="checkbox" value="<?php echo e($index); ?>" x-model="selectedRows" class="row-cb-details rounded border-slate-300 text-indigo-600 focus:ring-indigo-500">
                                </td>
                                <td class="p-3 text-slate-500"><?php echo e($index + 1); ?></td>
                                <td class="p-3 whitespace-nowrap text-slate-600"><?php echo e(\Carbon\Carbon::parse($row->date)->format('d/m/Y')); ?></td>
                                <td class="p-3 font-medium text-slate-700"><?php echo e($row->project_name); ?></td>
                                <td class="p-3">
                                    <span class="font-mono text-xs text-indigo-600 bg-indigo-50 rounded px-2 py-1 inline-block"><?php echo e($row->asset_code ?: 'N/A'); ?></span>
                                </td>
                                <td class="p-3 text-slate-600"><?php echo e($row->repair_staff ?: 'N/A'); ?></td>
                                <td class="p-3 font-semibold text-slate-700"><?php echo e($row->product_code); ?></td>
                                <td class="p-3 text-slate-600"><?php echo e($row->product_name); ?></td>
                                <td class="p-3 text-right font-bold text-slate-800"><?php echo e(number_format($row->quantity)); ?></td>
                            </tr>
