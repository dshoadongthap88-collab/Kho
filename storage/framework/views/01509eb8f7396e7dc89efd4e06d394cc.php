                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50/50 transition-colors <?php echo e(in_array((string)$asset->id, $selectedIds) ? 'bg-sky-50/40' : ''); ?>" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'row-'.e($asset->id).''; ?>wire:key="row-<?php echo e($asset->id); ?>">
                            ...
                            <td class="py-3 px-4 text-center">
                                <input type="text" 
                                       wire:model.defer="engine_oil_caps.<?php echo e($asset->id); ?>" 
                                       placeholder="8" 
                            ...
                            <td class="py-3 px-4 text-center">
                                <input type="text" 
                                       wire:model.defer="hydraulic_oil_caps.<?php echo e($asset->id); ?>" 
                                       placeholder="35" 
                                       class="w-16 py-1 px-1.5 text-center text-xs font-bold text-slate-800 bg-slate-50 hover:bg-white focus:bg-white border border-slate-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-100 rounded-md focus:outline-none transition-all placeholder:text-slate-300"
                                />
                            </td>
                            ...
                            <td class="py-3 px-4">
                                <input type="text" 
                                       wire:model.defer="engine_oil_filters.<?php echo e($asset->id); ?>" 
                                       placeholder="LF-3349" 
                            ...
                            <td class="py-3 px-4">
                                <input type="text" 
                                       wire:model.defer="hydraulic_filters.<?php echo e($asset->id); ?>" 
                                       placeholder="HF-6710" 
                                       class="w-full py-1 px-2.5 text-xs font-bold text-slate-800 bg-slate-50 hover:bg-white focus:bg-white border border-slate-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-100 rounded-md focus:outline-none transition-all placeholder:text-slate-300 uppercase"
                                />
                            </td>
                            ...
                            <td class="py-3 px-4">
                                <input type="text" 
                                       wire:model.defer="air_filters.<?php echo e($asset->id); ?>" 
                                       placeholder="AF-2555" 
                                       class="w-full py-1 px-2.5 text-xs font-bold text-slate-800 bg-slate-50 hover:bg-white focus:bg-white border border-slate-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-100 rounded-md focus:outline-none transition-all placeholder:text-slate-300 uppercase"
                                />
                            </td>
                            ...
                            <td class="py-3 px-4 text-center">
                                <input type="text" 
                                       wire:model.defer="maintenance_cycles.<?php echo e($asset->id); ?>" 
                                       placeholder="250 giờ" 
