    ...
    <div>
        ...
        <div class="bg-white rounded-xl shadow border mb-6">
            <div class="px-5 py-4 border-b flex items-center justify-between">
                <div>
                    <h2 class="text-base font-black text-indigo-800 uppercase">📋 Phiếu kiểm kê: <?php echo e($currentCount->code); ?></h2>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'sc-row-'.e($sc->id).''; ?>wire:key="sc-row-<?php echo e($sc->id); ?>" class="hover:bg-gray-50 transition-colors <?php echo e(in_array($sc->id, $selectedStockCounts) ? 'bg-indigo-50/50' : ''); ?>">
                        ...
                        <td class="px-4 py-3 text-sm font-bold text-indigo-700"><?php echo e($sc->code); ?></td>
                        <td class="px-4 py-3 text-center">
                            <span class="px-2 py-0.5 rounded-full text-[10px] font-bold <?php echo e($s['class']); ?>"><?php echo e($s['label']); ?></span>
                        </td>
                        <td class="px-4 py-3 text-xs text-gray-500"><?php echo e($sc->note); ?></td>
                        <td class="px-4 py-3 text-xs text-gray-600">👤 <?php echo e($sc->creator->name ?? '-'); ?></td>
                        <td class="px-4 py-3 text-xs text-gray-400 font-mono"><?php echo e($sc->created_at->format('d/m/Y H:i')); ?></td>
                ...
                <div class="border rounded-lg overflow-hidden">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr>
                                <td class="px-4 py-3">
                                    <div class="text-sm font-bold text-gray-800"><?php echo e($res['product_name']); ?></div>
                                    <div class="text-[10px] text-gray-400 font-mono"><?php echo e($res['product_code']); ?></div>
                                </td>
                                <td class="px-4 py-3 text-center font-bold"><?php echo e(number_format($res['stored_qty'])); ?></td>
                                <td class="px-4 py-3 text-center font-bold text-indigo-600"><?php echo e(number_format($res['calculated_qty'])); ?></td>
                                <td class="px-4 py-3 text-center font-black text-red-600"><?php echo e(number_format($res['difference'])); ?></td>
                            </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </tbody>
                    </table>
            ...
            <div class="space-y-4 overflow-y-auto pr-2 flex-1">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $chatMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="flex <?php echo e($msg['sender'] === 'user' ? 'justify-end' : 'justify-start'); ?> items-start gap-2.5">
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div class="flex flex-col w-full max-w-[450px] leading-1.5 p-4 border-gray-200 rounded-r-xl rounded-bl-xl <?php echo e($msg['sender'] === 'user' ? 'bg-indigo-600 text-white rounded-l-xl rounded-br-xl' : 'bg-white text-gray-800'); ?> shadow-sm">
