...
<body>
    ...
    <div class="header-left">
        ...
        <div class="title-strong">DỰ ÁN : <?php echo e(config('app.project_name', 'TÊN DỰ ÁN HIỆN TẠI')); ?></div>
    </div>
    ...
    <div style="text-align: center; margin-bottom: 20px; font-style: italic;">
        (Ngày xuất báo cáo: <?php echo e(\Carbon\Carbon::now()->format('d/m/Y H:i')); ?> - Người lập: <?php echo e(auth()->user()->name ?? 'N/A'); ?>)
    </div>
    ...
    <table>
        ...
        <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr>
                    ...
                    <td><?php echo e($item['stock_in_date']); ?></td>
                </tr>
...
<?php /**PATH D:\Project\resources\views\warehouse\prints\dead-stock-report.blade.php ENDPATH**/ ?>