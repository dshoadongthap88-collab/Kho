<div>
    <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex space-x-4">
            ...
            <a href="<?php echo e(route('warehouse.reports.daily.print', ['dateFrom' => $dateFrom, 'dateTo' => $dateTo, 'detailed' => $printDetailed ? 1 : 0])); ?>" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center shrink-0">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
        ...
        <div class="bg-white rounded-lg shadow p-2">
            ...
            <div class="flex items-center justify-between py-2 border-b">
                ...
                <span class="text-lg font-bold text-gray-800"><?php echo e($reportData['totalStockInOrders']); ?></span>
            </div>
            <div class="flex items-center justify-between py-2 border-b">
                <span class="text-sm text-gray-600">Tổng số mã vật tư nhập/ngày</span>
                <span class="text-lg font-bold text-gray-800"><?php echo e($reportData['stockInCount']); ?></span>
            </div>
            <div class="flex items-center justify-between py-2">
                <span class="text-sm text-gray-600">Tổng nhà cung cấp giao/ngày</span>
                <span class="text-lg font-bold text-gray-800"><?php echo e($reportData['supplierDeliveryCount']); ?></span>
            </div>
        </div>
