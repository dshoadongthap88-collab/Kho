...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.warehouse-layout','data' => ['title' => 'Định Mức Dầu Nhớt (BOM)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Định Mức Dầu Nhớt (BOM)']); ?>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3945578976-0', $__key);
...
<?php endif; ?>
<?php /**PATH D:\Project\resources\views/warehouse/asset/bom-manager.blade.php ENDPATH**/ ?>