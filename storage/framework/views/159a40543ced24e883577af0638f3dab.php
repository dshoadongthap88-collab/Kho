    ...
    <div class="hidden print:block absolute inset-0 bg-white z-[9999] w-full" style="min-height: 100vh;">
        ...
        <div style="font-family: 'Times New Roman', serif; padding: 15mm; width: 100%;">
            ...
            <div class="mb-4 text-left">
                ...
                <div class="font-bold uppercase mt-1" style="font-size: 16px; color: black;">DỰ ÁN: <?php echo e(mb_strtoupper($firstRecovery->stockOut?->project_name ?? (session('current_house', 1) == 2 ? 'HẬU NGHĨA' : (session('current_house', 1) == 3 ? 'CẦN GIỜ' : 'HÓC MÔN')), 'UTF-8')); ?></div>
            </div>
