<div class="space-y-4">
    <div class="grid grid-cols-1 md:grid-cols-5 gap-3">
        ...
        <div class="bg-white rounded-lg shadow-sm p-3 border border-slate-200 flex items-center justify-between">
            ...
            <p class="text-lg font-black text-slate-800"><?php echo e($totalPlans); ?></p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-3 border border-slate-200 flex items-center justify-between">
            ...
            <p class="text-lg font-black text-emerald-600"><?php echo e($completedPlans); ?></p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-3 border border-slate-200 flex items-center justify-between">
            ...
            <p class="text-lg font-black text-amber-600"><?php echo e($partialPlans); ?></p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-3 border border-slate-200 flex items-center justify-between">
            ...
            <p class="text-lg font-black text-rose-600"><?php echo e($unreceivedPlans); ?></p>
        </div>
        ...
        <div class="bg-slate-800 rounded-lg shadow-sm p-3 border border-slate-700 flex items-center justify-between">
            ...
            <p class="text-lg font-black text-white"><?php echo e(number_format($totalMissing, 0)); ?></p>
        </div>
    </div>
</div>
