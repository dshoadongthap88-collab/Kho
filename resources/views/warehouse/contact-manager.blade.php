<x-warehouse-layout title="Khách hàng/NCC">
    <div class="mb-4 p-2 bg-blue-100 border border-blue-400 text-blue-700 rounded">
        ...
        <ul class="mt-2 ml-4 text-sm">
            <li>• <a href="{{ route('warehouse.contacts') }}" class="underline font-semibold hover:text-blue-900">📋 Danh sách Khách hàng/NCC</a></li>
            <li>• <a href="{{ route('warehouse.purchase-request') }}" class="underline font-semibold hover:text-blue-900">📦 Đơn đặt hàng</a></li>
        </ul>
    </div>
