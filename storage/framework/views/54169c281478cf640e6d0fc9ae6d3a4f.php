                    ...
                    <tbody class="text-sm divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-indigo-50/50 transition-colors cursor-pointer <?php echo e(session('edited_user_id') == $user->id ? 'bg-indigo-50' : ''); ?>" 
                            ...
                            <td class="px-4 py-3 text-center" @click.stop>
                                <form action="<?php echo e(route('admin.users.destroy', $user->id)); ?>" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa nhân viên này?');" class="inline-block">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-100 mb-4">
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <label class="flex items-center p-1.5 hover:bg-white rounded cursor-pointer transition-colors border border-transparent hover:border-gray-200">
                                    ...
                                    <span class="ml-2 text-sm text-gray-700 font-medium"><?php echo e($i == 1 ? 'Dự án Hóc Môn' : ($i == 2 ? 'Dự án Hậu Nghĩa' : ($i == 3 ? 'Dự án Cần Giờ' : 'Dự án Số 4'))); ?></span>
                                </label>
        ...
        function employeeManagement() {
            return {
                ...
                openCreate() {
                    ...
                    this.formAction = '<?php echo e(route('admin.users.store')); ?>';
                    this.formData = {
                        id: '',
                        code: '',
                        name: '',
...
<?php /**PATH D:\Project\resources\views/admin/users/index.blade.php ENDPATH**/ ?>