            ...
            <tbody>
                ...
                <tr class="border-b border-slate-100 hover:bg-slate-50">
                    ...
                    <td class="p-4 text-sm">
                        <div class="flex flex-wrap gap-1">
                            ...
                            @forelse($projects->whereIn('id', $userHouses) as $p)
                                <span class="px-2 py-1 bg-slate-100 text-slate-700 rounded text-xs">{{ $p->name }}</span>
                            @empty
                    ...
                    <td class="p-4 text-right">
                        <button wire:click="edit({{ $user->id }})" class="px-3 py-1.5 bg-indigo-50 text-indigo-700 hover:bg-indigo-100 rounded-lg font-bold text-sm transition-colors border border-indigo-200">Phân quyền</button>
                    </td>
                </tr>
                @empty
                <tr>
