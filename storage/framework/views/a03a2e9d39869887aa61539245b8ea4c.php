        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-2 py-2 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Mã Cấp</th>
                        <th class="px-2 py-2 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Tên Cấp</th>
                        <th class="px-2 py-2 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Loại Thiết Bị</th>
                        <th class="px-2 py-2 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Hạng Mục</th>
                        <th class="px-2 py-2 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Chu Kỳ Giờ</th>
                        <th class="px-2 py-2 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Chu Kỳ Tháng</th>
                        <th class="px-2 py-2 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Vật Tư Cần Thay</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-indigo-600"><?php echo e($rule->rule_code); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-semibold text-gray-900"><?php echo e($rule->name); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-bold text-gray-900"><?php echo e($rule->machine_type); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm font-semibold text-indigo-600"><?php echo e($rule->category); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm text-center font-bold text-blue-600"><?php echo e($rule->cycle_hours > 0 ? number_format($rule->cycle_hours) . ' giờ' : '-'); ?></td>
                            <td class="px-2 py-1.5 whitespace-nowrap text-sm text-center text-gray-600"><?php echo e($rule->cycle_months > 0 ? $rule->cycle_months . ' tháng' : '-'); ?></td>
                            <td class="px-2 py-1.5 text-sm text-gray-500">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($rule->material_needed)): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rule->material_needed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <span class="inline-block bg-slate-100 px-2 py-0.5 rounded text-xs border border-slate-200 mr-1 mb-1"><?php echo e($mat); ?></span>
                            ...
                            <td class="px-2 py-1.5 whitespace-nowrap text-right text-sm font-medium">
                                <button wire:click="edit(<?php echo e($rule->id); ?>)" class="text-indigo-600 hover:text-indigo-900 mx-2 bg-indigo-50 hover:bg-indigo-100 p-1.5 rounded" title="Sửa">✏️</button>
                                <button x-on:click="if(confirm('Xóa định mức này?')) $wire.delete(<?php echo e($rule->id); ?>)" class="text-red-600 hover:text-red-900 bg-red-50 hover:bg-red-100 p-1.5 rounded" title="Xóa">🗑️</button>
                            </td>
                        </tr>
                    ...
                    <form wire:submit.prevent="save">
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-2 sm:pb-4">
                            <h3 class="text-lg leading-6 font-bold text-gray-900 mb-4" id="modal-title">
                                <?php echo e($ruleId ? 'Cập nhật định mức' : 'Thêm định mức mới'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="grid grid-cols-3 gap-2 p-2 bg-slate-50 rounded border border-slate-200">
                                    <div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['cycle_km'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['cycle_hours'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['cycle_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
<?php /**PATH D:\Project\resources\views\livewire\warehouse\maintenance-rule-manager.blade.php ENDPATH**/ ?>