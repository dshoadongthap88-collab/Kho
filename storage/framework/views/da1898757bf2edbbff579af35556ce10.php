            ...
            <tbody class="divide-y divide-gray-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="hover:bg-slate-50/80 transition group <?php echo e(in_array($order->id, $selectedIds) ? 'bg-amber-50 is-selected' : ''); ?>">
                        ...
                        <td class="px-2 py-1.5 font-mono font-black text-indigo-700"><?php echo e($order->po_number); ?></td>
                        <td class="px-2 py-1.5 text-gray-800"><?php echo e($order->supplier->name ?? 'N/A'); ?></td>
                        <td class="px-2 py-1.5 text-gray-700 text-sm">
                            <span class="bg-indigo-100 text-indigo-700 px-1.5 py-1 text-[11px] rounded-full text-xs">👤 <?php echo e($order->user?->name ?? 'Chưa ghi'); ?></span>
                        </td>
                        <td class="px-2 py-1.5 text-gray-600 text-sm"><?php echo e($order->order_date?->format('d/m/Y')); ?></td>
                        <td class="px-2 py-1.5 text-gray-600 text-sm"><?php echo e($order->expected_delivery_date?->format('d/m/Y')); ?></td>
                        <td class="px-2 py-1.5 font-semibold text-amber-700"><?php echo e(number_format($order->total_amount, 0, ',', '.')); ?> đ</td>
                        ...
                        <td class="px-2 py-1.5 text-right flex gap-1 justify-end no-print">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status === 'pending'): ?>
                                <button wire:click="confirmOrder(<?php echo e($order->id); ?>)" class="bg-emerald-500 hover:bg-emerald-600 text-white px-1.5 py-1 text-[11px] rounded text-[10px] font-black transition-all hover:scale-105 shadow-sm" title="Xác nhận">DUYỆT</button>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
